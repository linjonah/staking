...
// XXX Remove: import "./interfaces/IMasterChef.sol";
...
contract ChefV2 is BoringOwnable, BoringBatchable {
    ...
    // XXX Remove: IMasterChef public immutable MASTER_CHEF;
    /// @notice Address of SUSHI contract.
    IERC20 public immutable SUSHI;
    /// @notice The index of MCV2 master pool in MCV1.
    // XXX Remove: uint256 public immutable MASTER_PID;
    ...
    /// XXX Remove: event LogInit();

    /// @param _sushi The SUSHI token contract address.
    ///
    /// XXX Changed from: constructor(IMasterChef _MASTER_CHEF, IERC20 _sushi, uint256 _MASTER_PID) public
    ...
    ///
    /// XXX Remove: function init(IERC20 dummyToken) external
    ...
    function sushiPerBlock() public view returns (uint256 amount) {
        amount = MASTERCHEF_SUSHI_PER_BLOCK; // XXX Changed from: uint256(MASTERCHEF_SUSHI_PER_BLOCK).mul(MASTER_CHEF.poolInfo(MASTER_PID).allocPoint) / MASTER_CHEF.totalAllocPoint();
    }
    ...
    ///
    /// XXX Remove: function harvestFromMasterChef() public
